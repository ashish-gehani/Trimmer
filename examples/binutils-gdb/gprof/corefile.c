...
core_create_line_syms (void)
{
  ...
  printf("corefile.c : line 793\n");       
  prev_name = (char *) xmalloc (prev_name_len);
  printf("corefile.c : line 795\n");       
