...
main (int oldArgc, char ** oldArgv)
{
  ...
  argv[4] = malloc(sizeof(char) * 100);    
  argv[5] = malloc(sizeof(char) * 100);    
  argv[6] = malloc(sizeof(char) * 100);    
  argv[7] = malloc(sizeof(char) * 100);    
  memcpy(argv[1], "-h", 100);
  memcpy(argv[2], "-l", 100);
  memcpy(argv[3], "-S", 100);
  memcpy(argv[4], "-s", 100);
