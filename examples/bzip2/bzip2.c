...
IntNative main ( IntNative argc, Char *argv[] )
{
   ...
   // }
   // memcpy(argv[0], oldArgv[0], 100);
   // memcpy(argv[1], "-fkqs", 100);
   // memcpy(argv[2], "huffman.c", 100);   
