...
__attribute__((annotate("specializeArg")))
void init_useragent(struct OperationConfig *config) {
    config->useragent = malloc(sizeof(char) * 11);
    memcpy(config->useragent, "curl/7.47.0", 11);
}
