...
main(int argc, char * argv[])
{
  ...
  // argv[0] = oldArgv[0];
  // argv[1] = malloc(sizeof(char) * 100);
  // argv[2] = malloc(sizeof(char) * 100);
  // argv[3] = malloc(sizeof(char) * 100);
  // argv[4] = oldArgv[1];
  // argv[5] = malloc(sizeof(char) * 100);
  // argv[6] = oldArgv[2];
  // memcpy(argv[1], "-t", 100);
  // memcpy(argv[2], "TCP_STREAM", 100);
  // memcpy(argv[3], "-D", 100);
  // memcpy(argv[5], "-I", 100);
  ...
  else if (strcmp(test_name,"TCP_MSS") == 0) {
    send_tcp_mss(host_name);
  }
#ifdef HAVE_ICSC_EXS
  else if (strcmp(test_name,"EXS_TCP_STREAM") == 0) {
  ...
  else if (strcmp(test_name, "SCTP_RR") == 0) {
    send_sctp_rr(host_name);
  }
  else if (strcmp(test_name, "SCTP_STREAM_MANY") == 0) {
    send_sctp_stream_1toMany(host_name);
  }
  else if (strcmp(test_name, "SCTP_RR_MANY") == 0) {
  ...
  else if (strcmp(test_name,"SDP_MAERTS") == 0) {
    send_sdp_maerts(host_name);
  }
  else if (strcmp(test_name,"SDP_RR") == 0) {
  ...
  else if (strcmp(test_name,"UUID") == 0) {
