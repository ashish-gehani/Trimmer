...
char
  ...
  test_name[BUFSIZ] = "",   /* which test to run */
...
parse_direction(char direction_string[])
{
  ...
  else if ((strcmp(arg1,"xmit") == 0) ||
	   (strcmp(arg1,"send") == 0) ||
	   (strcmp(arg1,"stream") == 0) ||
	   (strcmp(arg1,"transmit") == 0)) {
    left = NETPERF_XMIT;
  }
  else if ((strcmp(arg1,"recv") == 0) ||
	   (strcmp(arg1,"receive") == 0) ||
	   (strcmp(arg1,"maerts") == 0)) {
...
void scan_cmd_line(int argc, char *argv[])
{
  ...
  *--p = 0;
  ...
  /* while the parsing of the command line will upshift the test name,
     ...
     will retain for now the strcmp calls rather than switch to
     strcmp. raj 20101220 */
  int size = strlen(test_name);
  printf("%s %d\n", test_name, size);
  if (
#ifndef WANT_MIGRATION
	(strcmp(test_name,"TCP_STREAM") == 0) ||
...
#endif
#ifdef HAVE_ICSC_EXS
	(strcmp(test_name,"EXS_TCP_STREAM") == 0) ||
#endif /* HAVE_ICSC_EXS */
#ifdef HAVE_SENDFILE
	(strcmp(test_name,"TCP_SENDFILE") == 0) ||
#endif /* HAVE_SENDFILE */
	(strcmp(test_name,"TCP_CC") == 0) ||
	(strcmp(test_name,"TCP_MSS") == 0) ||
#ifdef DO_1644
...
#ifdef WANT_SCTP
    else if ((strcmp(test_name,"SCTP_STREAM") == 0) ||
	     (strcmp(test_name,"SCTP_RR") == 0) ||
	     (strcmp(test_name,"SCTP_STREAM_MANY") == 0) ||
	     (strcmp(test_name,"SCTP_RR_MANY") == 0))
    {
...
#ifdef WANT_SDP
    else if((strcmp(test_name,"SDP_STREAM") == 0) ||
	    (strcmp(test_name,"SDP_MAERTS") == 0) ||
	    (strcmp(test_name,"SDP_RR") == 0))
      {
...
#ifdef WANT_OMNI
    else if ((strcmp(test_name,"OMNI") == 0) ||
