...
; <label>:5                                       ; preds = %0
  ...
  %13 = bitcast [15 x i8]* %buffer to i8*
  %14 = load i32, i32* %n, align 4
  %15 = sext i32 %14 to i64
  %16 = call i64 @read(i32 %2, i8* %13, i64 %15)
  %17 = getelementptr inbounds [15 x i8], [15 x i8]* %buffer, i32 0, i32 0
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str3, i32 0, i32 0), i8* %17)
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str4, i32 0, i32 0), i64 %16)
  %20 = bitcast [15 x i8]* %buffer to i8*
  %21 = call i64 @read(i32 %2, i8* %20, i64 10)
  %22 = getelementptr inbounds [15 x i8], [15 x i8]* %buffer, i32 0, i32 0
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str3, i32 0, i32 0), i8* %22)
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str4, i32 0, i32 0), i64 %21)
