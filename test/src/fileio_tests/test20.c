...
//test file open and read calls with first read call in a non-folded branch. Hence, file descriptor becomes non-constant and future file I/O calls are not folded.
...
int main(int argc, char ** argv) {
  char buffer[100];
  char buffer1[100];
  int fd = open("../data/configFile20.txt", O_RDONLY);
