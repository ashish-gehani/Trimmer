...
//A more complex example testing file open, read  and lseek calls, where a configuration structure (Config) is filled with static data from file.
...
int main(int argc, char ** argv) {
  ...
  parse_input("../data/configFile7.txt", config);
  branchPruned(config);
  return 0;
}
