...
//test the constant folding and propagation of an object of struct type, which contains array type variables. The branch in branchPruned function should be pruned.
