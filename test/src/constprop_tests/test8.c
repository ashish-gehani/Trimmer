...
//test the constant folding and propagation of an object of struct type, which contains pointer type variables. This also tests malloc instructions. The branch in branchPruned function should be pruned.
