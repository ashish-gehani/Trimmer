...
; <label>:3                                       ; preds = %0
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([23 x i8], [23 x i8]* @str.1, i64 0, i64 0))
  br label %4
...
define i32 @main() #0 {
  ...
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %4, label %branchNotPruned_clone.exit

; <label>:4                                       ; preds = %0
  %puts.i = call i32 @puts(i8* nonnull getelementptr inbounds ([23 x i8], [23 x i8]* @str.1, i64 0, i64 0)) #4
  br label %branchNotPruned_clone.exit

branchNotPruned_clone.exit:                       ; preds = %0, %4
  ret i32 0
}
