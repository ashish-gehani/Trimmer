...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @externalFunc(i8* %4)
  %5 = call i32 (i8*, i32, ...) @open(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i32 0)
...
; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0))
  br label %10

; <label>:10                                      ; preds = %8, %0
  %11 = load i32, i32* %fd, align 4
  %12 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  %13 = call i64 @read(i32 %11, i8* %12, i64 100)
  %14 = trunc i64 %13 to i32
  store i32 %14, i32* %bytes_read, align 4
  %15 = load i32, i32* %bytes_read, align 4
  ...
  call void @branchPruned(i32 %18, i8* %19)
  ret i32 0
}
