...
; <label>:8                                       ; preds = %4
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([17 x i8], [17 x i8]* @str.2, i64 0, i64 0))
  br label %9
...
; <label>:12                                      ; preds = %8
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([21 x i8], [21 x i8]* @str.3, i64 0, i64 0))
  br label %13
...
; <label>:5                                       ; preds = %4, %3
  ...
  %puts.i = tail call i32 @puts(i8* nonnull getelementptr inbounds ([17 x i8], [17 x i8]* @str.2, i64 0, i64 0)) #3
  ...
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %branchNotPruned_clone.exit

; <label>:14                                      ; preds = %5
  %puts.i3 = tail call i32 @puts(i8* nonnull getelementptr inbounds ([21 x i8], [21 x i8]* @str.3, i64 0, i64 0)) #3
  br label %branchNotPruned_clone.exit

branchNotPruned_clone.exit:                       ; preds = %5, %14
