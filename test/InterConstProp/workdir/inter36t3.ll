...
; <label>:5                                       ; preds = %3, %0
  ...
  call void @initConfig_clone(i8* %7, i32 %1)
  call void @readConfig_clone()
  %8 = load %struct.Config*, %struct.Config** @config, align 8
  %9 = getelementptr inbounds %struct.Config, %struct.Config* %8, i32 0, i32 0
  %10 = getelementptr inbounds [100 x i8], [100 x i8]* %9, i32 0, i32 0
  call void @branchNotPruned_clone(i8* %10)
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define void @initConfig_clone(i8* %str, i32 %fd) #0 {
  %1 = call noalias i8* @malloc(i64 104) #5
  %2 = bitcast i8* %1 to %struct.Config*
  store %struct.Config* %2, %struct.Config** @config, align 8
  %3 = load %struct.Config*, %struct.Config** @config, align 8
  %4 = getelementptr inbounds %struct.Config, %struct.Config* %3, i32 0, i32 1
  store i32 %fd, i32* %4, align 4
  %5 = getelementptr [2 x i8], [2 x i8]* @0, i64 0, i64 0
  %6 = call i32 @strcmp(i8* %str, i8* %5) #4
  %7 = icmp ne i32 %6, 0
  br i1 %7, label %13, label %8

; <label>:8                                       ; preds = %0
  %9 = load %struct.Config*, %struct.Config** @config, align 8
  %10 = getelementptr inbounds %struct.Config, %struct.Config* %9, i32 0, i32 1
  %11 = load i32, i32* %10, align 4
  %12 = call i64 @lseek(i32 %11, i64 11, i32 0) #5
  br label %13
