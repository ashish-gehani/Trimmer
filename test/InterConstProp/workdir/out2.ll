...
define void @branchPruned(i8* nocapture readonly %buffer) #0 {
  %1 = load i8, i8* %buffer, align 1
  %2 = icmp eq i8 %1, 105
...
; <label>:3                                       ; preds = %0
  %4 = tail call i32 @strcmp(i8* nonnull %buffer, i8* nonnull getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0)) #5
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %6, label %9

; <label>:6                                       ; preds = %3
  %7 = tail call i32 @strcmp(i8* nonnull %buffer, i8* nonnull getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0)) #5
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %10, label %9

; <label>:9                                       ; preds = %0, %0, %6, %3
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([16 x i8], [16 x i8]* @str.3, i64 0, i64 0))
  br label %10
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  br i1 %1, label %2, label %modify_clone.exit

; <label>:2                                       ; preds = %0
  store i8 97, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i64 0, i64 1), align 1
  br label %modify_clone.exit

modify_clone.exit:                                ; preds = %0, %2
  %puts.i1 = tail call i32 @puts(i8* nonnull getelementptr inbounds ([13 x i8], [13 x i8]* @str.2, i64 0, i64 0)) #4
  %3 = load i8, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i64 0, i64 1), align 1
  switch i8 %3, label %4 [
    i8 97, label %10
    i8 101, label %10
  ]

; <label>:4                                       ; preds = %modify_clone.exit
  %5 = tail call i32 @strcmp(i8* nonnull getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i64 0, i64 0), i8* nonnull getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0)) #5
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %7, label %10

; <label>:7                                       ; preds = %4
  %8 = tail call i32 @strcmp(i8* nonnull getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i64 0, i64 0), i8* nonnull getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0)) #5
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %branchNotPruned_clone.exit, label %10

; <label>:10                                      ; preds = %7, %4, %modify_clone.exit, %modify_clone.exit
  %puts.i = tail call i32 @puts(i8* nonnull getelementptr inbounds ([16 x i8], [16 x i8]* @str.3, i64 0, i64 0)) #4
  br label %branchNotPruned_clone.exit

branchNotPruned_clone.exit:                       ; preds = %7, %10
  ret i32 0
}
