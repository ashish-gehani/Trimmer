...
define i32 @main() #0 {
  ...
  call void @initialize_clone_clone(%struct.stType* %obj)
  call void @branchPruned_clone_clone(%struct.stType* %obj)
  ret i32 0
}
...
define void @branchPruned_clone(%struct.stType* byval align 8 %obj) #0 {
  ...
  %2 = getelementptr inbounds %struct.COORD, %struct.COORD* %1, i32 0, i32 0
  %3 = load i32, i32* %2, align 8
  br i1 true, label %4, label %26

; <label>:4                                       ; preds = %0
  %5 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 0
  %6 = getelementptr inbounds %struct.COORD, %struct.COORD* %5, i32 0, i32 1
  %7 = load i32, i32* %6, align 4
  br i1 true, label %8, label %26

; <label>:8                                       ; preds = %4
  %9 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 2
  %10 = getelementptr inbounds [8 x i32], [8 x i32]* %9, i64 0, i64 1
  %11 = load i32, i32* %10, align 4
  br i1 true, label %12, label %26

; <label>:12                                      ; preds = %8
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %14 = getelementptr inbounds [100 x i8], [100 x i8]* %13, i32 0, i32 0
  %15 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #4
  br i1 false, label %26, label %16

; <label>:16                                      ; preds = %12
  %17 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %18 = getelementptr inbounds [100 x i8], [100 x i8]* %17, i64 0, i64 4
  %19 = load i8, i8* %18, align 4
  br i1 true, label %20, label %26

; <label>:20                                      ; preds = %16
  %21 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %22 = getelementptr inbounds [100 x i8], [100 x i8]* %21, i64 0, i64 9
  %23 = load i8, i8* %22, align 1
  br i1 true, label %24, label %26

; <label>:24                                      ; preds = %20
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %26

; <label>:26                                      ; preds = %24, %20, %16, %12, %8, %4, %0
  ret void
}

; Function Attrs: nounwind uwtable
define void @initialize_clone_clone(%struct.stType* %obj) #0 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 0
  %2 = getelementptr inbounds %struct.COORD, %struct.COORD* %1, i32 0, i32 0
  store i32 4, i32* %2, align 4
  %3 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 0
