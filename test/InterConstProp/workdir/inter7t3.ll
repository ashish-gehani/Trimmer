...
; <label>:10                                      ; preds = %5
  ...
  br i1 true, label %15, label %36

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %17 = getelementptr inbounds [100 x i8], [100 x i8]* %16, i32 0, i32 0
  %18 = getelementptr [11 x i8], [11 x i8]* @0, i64 0, i64 0
  %19 = getelementptr [11 x i8], [11 x i8]* @1, i64 0, i64 0
  %20 = call i32 @strcmp(i8* %18, i8* %19) #4
  %21 = icmp ne i32 0, 0
  br i1 false, label %36, label %22

; <label>:22                                      ; preds = %15
  %23 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %24 = getelementptr inbounds [100 x i8], [100 x i8]* %23, i64 0, i64 4
  %25 = load i8, i8* %24, align 4
  %26 = sext i8 111 to i32
  %27 = icmp eq i32 111, 111
  br i1 true, label %28, label %36

; <label>:28                                      ; preds = %22
  %29 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i32 0, i32 1
  %30 = getelementptr inbounds [100 x i8], [100 x i8]* %29, i64 0, i64 9
  %31 = load i8, i8* %30, align 1
  %32 = sext i8 100 to i32
  %33 = icmp eq i32 100, 100
  br i1 true, label %34, label %36

; <label>:34                                      ; preds = %28
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %36

; <label>:36                                      ; preds = %34, %28, %22, %15, %10, %5, %0
  ret void
}
