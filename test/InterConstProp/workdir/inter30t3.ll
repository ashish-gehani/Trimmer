...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %21
  %12 = phi i32 [ %22, %21 ], [ 97, %.lr.ph.preheader ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %0
  ...
  call void @branchPruned_clone(i64 %24, i64 %25)
  %26 = load i32, i32* @optind, align 4
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0), i32 2)
  ret i32 0
}
