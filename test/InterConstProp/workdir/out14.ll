...
; <label>:125                                     ; preds = %121
  ...
  br i1 %128, label %129, label %branchNotPruned_clone_clone.exit
...
branchNotPruned_clone_clone.exit:                 ; preds = %125, %129
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone_clone(%struct.stType** nocapture readonly %obj) #0 {
  %1 = load %struct.stType*, %struct.stType** %obj, align 8
  %2 = getelementptr inbounds %struct.stType, %struct.stType* %1, i64 0, i32 2, i64 1
  %3 = load i32, i32* %2, align 4
  %4 = icmp eq i32 %3, 4
