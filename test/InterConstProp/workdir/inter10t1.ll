...
define void @initialize(%struct.HighType*) #0 {
  ...
  %102 = getelementptr inbounds [1000 x i8], [1000 x i8]* %101, i64 0, i64 778
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %102, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.9, i32 0, i32 0), i64 23, i32 1, i1 false)
  ret void
}
