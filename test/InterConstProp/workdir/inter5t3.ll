...
define void @branchNotPruned(i8* %buffer, i8* %buffer2) #0 {
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i64 100, i32 1, i1 false)
  %2 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i64 100, i32 1, i1 false)
  %3 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  %4 = call i32 (i8*, ...) bitcast (i32 (...)* @externalFuncbranch to i32 (i8*, ...)*)(i8* %3)
  ...
  call void @branchNotPruned(i8* %5, i8* %6)
  ret i32 0
}
...
declare i32 @externalFuncbranch(...) #2

; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone(i8* %buffer, i8* %buffer2) #0 {
  %1 = call i32 @strcmp(i8* %buffer, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @0, i64 0, i64 0)) #4
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %3, label %5
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone.1(i8* %buffer, i8* %buffer2) #0 {
  %1 = getelementptr [10 x i8], [10 x i8]* @1, i64 0, i64 0
