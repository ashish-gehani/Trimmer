...
; <label>:5                                       ; preds = %0
  %puts3 = tail call i32 @puts(i8* nonnull getelementptr inbounds ([10 x i8], [10 x i8]* @str.4, i64 0, i64 0))
  br label %19
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @str.4, i64 0, i64 0)) #4
  ret i32 0
}
