...
@1 = constant [1 x i8] zeroinitializer
...
define void @initialize(i8* %buffer) #0 {
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %buffer, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
...
define void @unroll_loop(i32 %i) #0 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i32 %i)
  ret void
}
...
define i32 @main() #0 {
  ...
  call void @initialize_clone(i8* %1)
  br label %2

; <label>:2                                       ; preds = %0, %2
  %i.01 = phi i32 [ 0, %0 ], [ %4, %2 ]
  %3 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @initialize(i8* %3)
  %4 = add nsw i32 %i.01, 1
  %5 = icmp slt i32 %4, 10
  br i1 %5, label %2, label %6

; <label>:6                                       ; preds = %2
  %7 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  %8 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @branchPruned_clone(i8* %7, i8* %8)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define void @initialize_clone(i8* %buffer) #0 {
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %buffer, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
