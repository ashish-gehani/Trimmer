...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @branchPruned_clone_clone(i8* %3, i8* %4)
  ret i32 0
}
...
define void @branchPruned_clone(i8* %buffer, i8* %buffer2) #0 {
  %1 = call i32 @strcmp(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @1, i64 0, i64 0)) #4
  br i1 true, label %2, label %4

; <label>:2                                       ; preds = %0
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i32 0, i32 0))
  br label %4
...
; Function Attrs: nounwind uwtable
define void @branchPruned_clone_clone(i8* %buffer, i8* %buffer2) #0 {
  %1 = call i32 @strcmp(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @1, i64 0, i64 0)) #4
  br i1 true, label %2, label %4
