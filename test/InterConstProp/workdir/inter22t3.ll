...
define void @branchPruned(i8* %buffer) #0 {
  %1 = call i64 @strcspn(i8* %buffer, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0)) #4
  %2 = trunc i64 %1 to i32
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds i8, i8* %buffer, i64 %3
...
; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* %buffer)
...
define i32 @main() #0 {
  ...
  call void @branchPruned_clone_clone(i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i32 0, i32 0))
  ret i32 0
}
...
define void @branchPruned_clone(i8* %buffer) #0 {
  ...
  %2 = getelementptr inbounds i8, i8* %buffer, i64 2
...
; <label>:6                                       ; preds = %0
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* %buffer)
...
; <label>:7                                       ; preds = %0
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* %buffer)
