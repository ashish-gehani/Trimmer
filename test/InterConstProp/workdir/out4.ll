...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @str.2, i64 0, i64 0)) #2
  ret i32 0
}

; Function Attrs: nounwind uwtable
define void @branchPruned_clone(i8* nocapture readnone %buffer, i8* nocapture readnone %buffer2) #0 {
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @str.2, i64 0, i64 0))
  ret void
}
