...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  %1 = tail call i32 (i8*, i32, ...) @open(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i32 0) #3
  %2 = icmp slt i32 %1, 0
...
; <label>:4                                       ; preds = %3, %0
  %5 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i64 0, i64 0
  %6 = call i64 @read(i32 %1, i8* %5, i64 100) #3
  %puts.i = tail call i32 @puts(i8* nonnull getelementptr inbounds ([13 x i8], [13 x i8]* @str.2, i64 0, i64 0)) #3
  ret i32 0
}
