...
; <label>:9:                                      ; preds = %2
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i32 0, i32 0))
  br label %11
...
define void @unroll_loop(i32) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i32 %3)
  ret void
}
...
; <label>:14:                                     ; preds = %6
  ...
  call void @branchPruned(i8* %15, i8* %16)
  ret i32 0
}
