...
; Function Attrs: nounwind uwtable
define void @initialize(i8* %buffer) #0 {
  %1 = alloca i8*, align 8
  store i8* %buffer, i8** %1, align 8
...
define void @unroll_loop(i32 %i) #0 {
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i32 %2)
  ret void
}
...
; <label>:6                                       ; preds = %3
  %7 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @initialize(i8* %7)
  br label %8
...
; <label>:11                                      ; preds = %3
  %12 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  %13 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer2, i32 0, i32 0
  call void @branchPruned(i8* %12, i8* %13)
  ret i32 0
}
