...
; <label>:6                                       ; preds = %0
  ...
  %9 = tail call i32 @strcmp(i8* %8, i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0)) #3
  %10 = icmp eq i32 %9, 0
...
; <label>:16                                      ; preds = %11
  ...
  %19 = tail call i32 @strcmp(i8* %18, i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #3
  %20 = icmp eq i32 %19, 0
...
; <label>:26                                      ; preds = %21
  ...
  %29 = tail call i32 @strcmp(i8* %28, i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0)) #3
  %30 = icmp eq i32 %29, 0
...
; <label>:36                                      ; preds = %31
  ...
  %39 = tail call i32 @strcmp(i8* %38, i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i64 0, i64 0)) #3
  %40 = icmp eq i32 %39, 0
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.2, i64 0, i64 0)) #2
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define void @branchPruned_clone_clone(%struct.stType* nocapture readnone %st) #0 {
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.2, i64 0, i64 0))
  ret void
}
