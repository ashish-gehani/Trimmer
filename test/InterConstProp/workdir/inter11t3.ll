...
define i32 @main() #0 {
  ...
  call void @branchPruned_clone_clone(%struct.stType** %2)
  ret i32 0
}
...
; <label>:8                                       ; preds = %0
  ...
  br i1 true, label %16, label %210

; <label>:16                                      ; preds = %8
  %17 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 0
  %18 = load %struct.stType*, %struct.stType** %17, align 8
  %19 = getelementptr inbounds %struct.stType, %struct.stType* %18, i32 0, i32 2
  %20 = getelementptr inbounds [8 x i32], [8 x i32]* %19, i64 0, i64 1
  %21 = load i32, i32* %20, align 4
  br i1 true, label %22, label %210
...
; <label>:22                                      ; preds = %16
  ...
  %27 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %210, label %28
...
; <label>:28                                      ; preds = %22
  ...
  %32 = getelementptr inbounds [100 x i8], [100 x i8]* %31, i64 0, i64 4
  %33 = load i8, i8* %32, align 4
  br i1 true, label %34, label %210
...
; <label>:34                                      ; preds = %28
  ...
  br i1 true, label %40, label %210

; <label>:40                                      ; preds = %34
  %41 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  %42 = load %struct.stType*, %struct.stType** %41, align 8
  %43 = getelementptr inbounds %struct.stType, %struct.stType* %42, i32 0, i32 0
  %44 = load %struct.COORD*, %struct.COORD** %43, align 8
  %45 = getelementptr inbounds %struct.COORD, %struct.COORD* %44, i32 0, i32 0
  %46 = load i32*, i32** %45, align 8
  %47 = load i32, i32* %46, align 4
  br i1 true, label %48, label %210
...
; <label>:48                                      ; preds = %40
  ...
  %51 = getelementptr inbounds %struct.stType, %struct.stType* %50, i32 0, i32 0
  %52 = load %struct.COORD*, %struct.COORD** %51, align 8
  %53 = getelementptr inbounds %struct.COORD, %struct.COORD* %52, i32 0, i32 1
  %54 = load i32*, i32** %53, align 8
  %55 = load i32, i32* %54, align 4
  br i1 true, label %56, label %210

; <label>:56                                      ; preds = %48
  %57 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  %58 = load %struct.stType*, %struct.stType** %57, align 8
  %59 = getelementptr inbounds %struct.stType, %struct.stType* %58, i32 0, i32 2
  %60 = getelementptr inbounds [8 x i32], [8 x i32]* %59, i64 0, i64 1
  %61 = load i32, i32* %60, align 4
  br i1 true, label %62, label %210

; <label>:62                                      ; preds = %56
  %63 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  ...
  %67 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %210, label %68
...
; <label>:68                                      ; preds = %62
  ...
  %72 = getelementptr inbounds [100 x i8], [100 x i8]* %71, i64 0, i64 4
  %73 = load i8, i8* %72, align 4
  br i1 true, label %74, label %210

; <label>:74                                      ; preds = %68
  %75 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  %76 = load %struct.stType*, %struct.stType** %75, align 8
  %77 = getelementptr inbounds %struct.stType, %struct.stType* %76, i32 0, i32 1
  %78 = getelementptr inbounds [100 x i8], [100 x i8]* %77, i64 0, i64 9
  %79 = load i8, i8* %78, align 1
  br i1 true, label %80, label %210

; <label>:80                                      ; preds = %74
  %81 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %82 = load %struct.stType*, %struct.stType** %81, align 8
  %83 = getelementptr inbounds %struct.stType, %struct.stType* %82, i32 0, i32 0
  %84 = load %struct.COORD*, %struct.COORD** %83, align 8
  %85 = getelementptr inbounds %struct.COORD, %struct.COORD* %84, i32 0, i32 0
  %86 = load i32*, i32** %85, align 8
  %87 = load i32, i32* %86, align 4
  br i1 true, label %88, label %210

; <label>:88                                      ; preds = %80
  %89 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %90 = load %struct.stType*, %struct.stType** %89, align 8
  %91 = getelementptr inbounds %struct.stType, %struct.stType* %90, i32 0, i32 0
  %92 = load %struct.COORD*, %struct.COORD** %91, align 8
  %93 = getelementptr inbounds %struct.COORD, %struct.COORD* %92, i32 0, i32 1
  %94 = load i32*, i32** %93, align 8
  %95 = load i32, i32* %94, align 4
  br i1 true, label %96, label %210

; <label>:96                                      ; preds = %88
  %97 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %98 = load %struct.stType*, %struct.stType** %97, align 8
  %99 = getelementptr inbounds %struct.stType, %struct.stType* %98, i32 0, i32 2
  %100 = getelementptr inbounds [8 x i32], [8 x i32]* %99, i64 0, i64 1
  %101 = load i32, i32* %100, align 4
  br i1 true, label %102, label %210

; <label>:102                                     ; preds = %96
  %103 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %104 = load %struct.stType*, %struct.stType** %103, align 8
  %105 = getelementptr inbounds %struct.stType, %struct.stType* %104, i32 0, i32 1
  %106 = getelementptr inbounds [100 x i8], [100 x i8]* %105, i32 0, i32 0
  %107 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %210, label %108

; <label>:108                                     ; preds = %102
  %109 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %110 = load %struct.stType*, %struct.stType** %109, align 8
  %111 = getelementptr inbounds %struct.stType, %struct.stType* %110, i32 0, i32 1
  %112 = getelementptr inbounds [100 x i8], [100 x i8]* %111, i64 0, i64 4
  %113 = load i8, i8* %112, align 4
  br i1 true, label %114, label %210
...
; <label>:114                                     ; preds = %108
  ...
  br i1 true, label %120, label %210

; <label>:120                                     ; preds = %114
  %121 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  ...
  %125 = getelementptr inbounds %struct.COORD, %struct.COORD* %124, i32 0, i32 0
  %126 = load i32*, i32** %125, align 8
  %127 = load i32, i32* %126, align 4
  br i1 true, label %128, label %210

; <label>:128                                     ; preds = %120
  %129 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %130 = load %struct.stType*, %struct.stType** %129, align 8
  %131 = getelementptr inbounds %struct.stType, %struct.stType* %130, i32 0, i32 0
  %132 = load %struct.COORD*, %struct.COORD** %131, align 8
  %133 = getelementptr inbounds %struct.COORD, %struct.COORD* %132, i32 0, i32 1
  %134 = load i32*, i32** %133, align 8
  %135 = load i32, i32* %134, align 4
  br i1 true, label %136, label %210

; <label>:136                                     ; preds = %128
  %137 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %138 = load %struct.stType*, %struct.stType** %137, align 8
  ...
  br i1 true, label %142, label %210

; <label>:142                                     ; preds = %136
  %143 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %144 = load %struct.stType*, %struct.stType** %143, align 8
  ...
  %147 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %210, label %148

; <label>:148                                     ; preds = %142
  %149 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %150 = load %struct.stType*, %struct.stType** %149, align 8
  %151 = getelementptr inbounds %struct.stType, %struct.stType* %150, i32 0, i32 1
  %152 = getelementptr inbounds [100 x i8], [100 x i8]* %151, i64 0, i64 4
  %153 = load i8, i8* %152, align 4
  br i1 true, label %154, label %210

; <label>:154                                     ; preds = %148
  %155 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %156 = load %struct.stType*, %struct.stType** %155, align 8
  %157 = getelementptr inbounds %struct.stType, %struct.stType* %156, i32 0, i32 1
  %158 = getelementptr inbounds [100 x i8], [100 x i8]* %157, i64 0, i64 9
  %159 = load i8, i8* %158, align 1
  br i1 true, label %160, label %210

; <label>:160                                     ; preds = %154
  %161 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 4
  %162 = load %struct.stType*, %struct.stType** %161, align 8
  br i1 true, label %163, label %210

; <label>:163                                     ; preds = %160
  %164 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 5
  %165 = load %struct.stType*, %struct.stType** %164, align 8
  br i1 true, label %166, label %210

; <label>:166                                     ; preds = %163
  %167 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 6
  %168 = load %struct.stType*, %struct.stType** %167, align 8
  br i1 true, label %169, label %210

; <label>:169                                     ; preds = %166
  %170 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 7
  %171 = load %struct.stType*, %struct.stType** %170, align 8
  br i1 true, label %172, label %210

; <label>:172                                     ; preds = %169
  %173 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 8
  %174 = load %struct.stType*, %struct.stType** %173, align 8
  br i1 true, label %175, label %210

; <label>:175                                     ; preds = %172
  %176 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 9
  %177 = load %struct.stType*, %struct.stType** %176, align 8
  br i1 true, label %178, label %210

; <label>:178                                     ; preds = %175
  %179 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 10
  %180 = load %struct.stType*, %struct.stType** %179, align 8
  br i1 true, label %181, label %210

; <label>:181                                     ; preds = %178
  %182 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 11
  %183 = load %struct.stType*, %struct.stType** %182, align 8
  br i1 true, label %184, label %210

; <label>:184                                     ; preds = %181
  %185 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 12
  %186 = load %struct.stType*, %struct.stType** %185, align 8
  br i1 true, label %187, label %210

; <label>:187                                     ; preds = %184
  %188 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 13
  %189 = load %struct.stType*, %struct.stType** %188, align 8
  br i1 true, label %190, label %210

; <label>:190                                     ; preds = %187
  %191 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 14
  %192 = load %struct.stType*, %struct.stType** %191, align 8
  br i1 true, label %193, label %210

; <label>:193                                     ; preds = %190
  %194 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 15
  %195 = load %struct.stType*, %struct.stType** %194, align 8
  br i1 true, label %196, label %210

; <label>:196                                     ; preds = %193
  %197 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 16
  %198 = load %struct.stType*, %struct.stType** %197, align 8
  br i1 true, label %199, label %210

; <label>:199                                     ; preds = %196
  %200 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 17
  %201 = load %struct.stType*, %struct.stType** %200, align 8
  br i1 true, label %202, label %210

; <label>:202                                     ; preds = %199
  %203 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 18
  %204 = load %struct.stType*, %struct.stType** %203, align 8
  br i1 true, label %205, label %210

; <label>:205                                     ; preds = %202
  %206 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 19
  %207 = load %struct.stType*, %struct.stType** %206, align 8
  br i1 true, label %208, label %210

; <label>:208                                     ; preds = %205
  %209 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %210

; <label>:210                                     ; preds = %208, %205, %202, %199, %196, %193, %190, %187, %184, %181, %178, %175, %172, %169, %166, %163, %160, %154, %148, %142, %136, %128, %120, %114, %108, %102, %96, %88, %80, %74, %68, %62, %56, %48, %40, %34, %28, %22, %16, %8, %0
  ret void
}
