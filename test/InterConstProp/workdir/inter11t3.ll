...
; <label>:25                                      ; preds = %18
  ...
  %28 = getelementptr inbounds %struct.stType, %struct.stType* %27, i32 0, i32 1
  %29 = getelementptr inbounds [100 x i8], [100 x i8]* %28, i32 0, i32 0
  %30 = getelementptr [11 x i8], [11 x i8]* @0, i64 0, i64 0
  %31 = getelementptr [11 x i8], [11 x i8]* @1, i64 0, i64 0
  %32 = call i32 @strcmp(i8* %30, i8* %31) #5
  %33 = icmp ne i32 0, 0
  br i1 false, label %282, label %34
...
; <label>:34                                      ; preds = %25
  ...
  %38 = getelementptr inbounds [100 x i8], [100 x i8]* %37, i64 0, i64 4
  %39 = load i8, i8* %38, align 4
  %40 = sext i8 111 to i32
  %41 = icmp eq i32 111, 111
  br i1 true, label %42, label %282

; <label>:42                                      ; preds = %34
  %43 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 0
  %44 = load %struct.stType*, %struct.stType** %43, align 8
  %45 = getelementptr inbounds %struct.stType, %struct.stType* %44, i32 0, i32 1
  %46 = getelementptr inbounds [100 x i8], [100 x i8]* %45, i64 0, i64 9
  %47 = load i8, i8* %46, align 1
  %48 = sext i8 100 to i32
  %49 = icmp eq i32 100, 100
  br i1 true, label %50, label %282

; <label>:50                                      ; preds = %42
  %51 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  %52 = load %struct.stType*, %struct.stType** %51, align 8
  %53 = getelementptr inbounds %struct.stType, %struct.stType* %52, i32 0, i32 0
  %54 = load %struct.COORD*, %struct.COORD** %53, align 8
  %55 = getelementptr inbounds %struct.COORD, %struct.COORD* %54, i32 0, i32 0
  %56 = load i32*, i32** %55, align 8
  %57 = load i32, i32* %56, align 4
  %58 = icmp eq i32 6, 6
  br i1 true, label %59, label %282

; <label>:59                                      ; preds = %50
  %60 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  %61 = load %struct.stType*, %struct.stType** %60, align 8
  %62 = getelementptr inbounds %struct.stType, %struct.stType* %61, i32 0, i32 0
  ...
  %67 = icmp eq i32 7, 7
  br i1 true, label %68, label %282

; <label>:68                                      ; preds = %59
  %69 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  ...
  %74 = icmp eq i32 9, 9
  br i1 true, label %75, label %282

; <label>:75                                      ; preds = %68
  %76 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  ...
  %80 = getelementptr [11 x i8], [11 x i8]* @2, i64 0, i64 0
  %81 = getelementptr [11 x i8], [11 x i8]* @3, i64 0, i64 0
  %82 = call i32 @strcmp(i8* %80, i8* %81) #5
  %83 = icmp ne i32 0, 0
  br i1 false, label %282, label %84

; <label>:84                                      ; preds = %75
  %85 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  ...
  %90 = sext i8 111 to i32
  %91 = icmp eq i32 111, 111
  br i1 true, label %92, label %282

; <label>:92                                      ; preds = %84
  %93 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 1
  ...
  %98 = sext i8 100 to i32
  %99 = icmp eq i32 100, 100
  br i1 true, label %100, label %282

; <label>:100                                     ; preds = %92
  %101 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  ...
  %105 = getelementptr inbounds %struct.COORD, %struct.COORD* %104, i32 0, i32 0
  %106 = load i32*, i32** %105, align 8
  %107 = load i32, i32* %106, align 4
  %108 = icmp eq i32 11, 11
  br i1 true, label %109, label %282

; <label>:109                                     ; preds = %100
  %110 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  ...
  %114 = getelementptr inbounds %struct.COORD, %struct.COORD* %113, i32 0, i32 1
  %115 = load i32*, i32** %114, align 8
  %116 = load i32, i32* %115, align 4
  %117 = icmp eq i32 12, 12
  br i1 true, label %118, label %282

; <label>:118                                     ; preds = %109
  %119 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %120 = load %struct.stType*, %struct.stType** %119, align 8
  %121 = getelementptr inbounds %struct.stType, %struct.stType* %120, i32 0, i32 2
  %122 = getelementptr inbounds [8 x i32], [8 x i32]* %121, i64 0, i64 1
  %123 = load i32, i32* %122, align 4
  %124 = icmp eq i32 14, 14
  br i1 true, label %125, label %282

; <label>:125                                     ; preds = %118
  %126 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %127 = load %struct.stType*, %struct.stType** %126, align 8
  %128 = getelementptr inbounds %struct.stType, %struct.stType* %127, i32 0, i32 1
  %129 = getelementptr inbounds [100 x i8], [100 x i8]* %128, i32 0, i32 0
  %130 = getelementptr [11 x i8], [11 x i8]* @4, i64 0, i64 0
  %131 = getelementptr [11 x i8], [11 x i8]* @5, i64 0, i64 0
  %132 = call i32 @strcmp(i8* %130, i8* %131) #5
  %133 = icmp ne i32 0, 0
  br i1 false, label %282, label %134

; <label>:134                                     ; preds = %125
  %135 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %136 = load %struct.stType*, %struct.stType** %135, align 8
  %137 = getelementptr inbounds %struct.stType, %struct.stType* %136, i32 0, i32 1
  %138 = getelementptr inbounds [100 x i8], [100 x i8]* %137, i64 0, i64 4
  %139 = load i8, i8* %138, align 4
  %140 = sext i8 111 to i32
  %141 = icmp eq i32 111, 111
  br i1 true, label %142, label %282

; <label>:142                                     ; preds = %134
  %143 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %144 = load %struct.stType*, %struct.stType** %143, align 8
  %145 = getelementptr inbounds %struct.stType, %struct.stType* %144, i32 0, i32 1
  %146 = getelementptr inbounds [100 x i8], [100 x i8]* %145, i64 0, i64 9
  %147 = load i8, i8* %146, align 1
  %148 = sext i8 100 to i32
  %149 = icmp eq i32 100, 100
  br i1 true, label %150, label %282

; <label>:150                                     ; preds = %142
  %151 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %152 = load %struct.stType*, %struct.stType** %151, align 8
  ...
  %158 = icmp eq i32 16, 16
  br i1 true, label %159, label %282

; <label>:159                                     ; preds = %150
  %160 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  ...
  %164 = getelementptr inbounds %struct.COORD, %struct.COORD* %163, i32 0, i32 1
  %165 = load i32*, i32** %164, align 8
  %166 = load i32, i32* %165, align 4
  %167 = icmp eq i32 17, 17
  br i1 true, label %168, label %282

; <label>:168                                     ; preds = %159
  %169 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %170 = load %struct.stType*, %struct.stType** %169, align 8
  ...
  %174 = icmp eq i32 19, 19
  br i1 true, label %175, label %282

; <label>:175                                     ; preds = %168
  %176 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %177 = load %struct.stType*, %struct.stType** %176, align 8
  %178 = getelementptr inbounds %struct.stType, %struct.stType* %177, i32 0, i32 1
  %179 = getelementptr inbounds [100 x i8], [100 x i8]* %178, i32 0, i32 0
  %180 = getelementptr [11 x i8], [11 x i8]* @6, i64 0, i64 0
  %181 = getelementptr [11 x i8], [11 x i8]* @7, i64 0, i64 0
  %182 = call i32 @strcmp(i8* %180, i8* %181) #5
  %183 = icmp ne i32 0, 0
  br i1 false, label %282, label %184

; <label>:184                                     ; preds = %175
  %185 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %186 = load %struct.stType*, %struct.stType** %185, align 8
  %187 = getelementptr inbounds %struct.stType, %struct.stType* %186, i32 0, i32 1
  %188 = getelementptr inbounds [100 x i8], [100 x i8]* %187, i64 0, i64 4
  %189 = load i8, i8* %188, align 4
  %190 = sext i8 111 to i32
  %191 = icmp eq i32 111, 111
  br i1 true, label %192, label %282

; <label>:192                                     ; preds = %184
  %193 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %194 = load %struct.stType*, %struct.stType** %193, align 8
  %195 = getelementptr inbounds %struct.stType, %struct.stType* %194, i32 0, i32 1
  %196 = getelementptr inbounds [100 x i8], [100 x i8]* %195, i64 0, i64 9
  %197 = load i8, i8* %196, align 1
  %198 = sext i8 100 to i32
  %199 = icmp eq i32 100, 100
  br i1 true, label %200, label %282

; <label>:200                                     ; preds = %192
  %201 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 4
  %202 = load %struct.stType*, %struct.stType** %201, align 8
  %203 = icmp eq i1 false, false
  %204 = icmp eq %struct.stType* null, null
  br i1 true, label %205, label %282

; <label>:205                                     ; preds = %200
  %206 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 5
  %207 = load %struct.stType*, %struct.stType** %206, align 8
  %208 = icmp eq i1 false, false
  %209 = icmp eq %struct.stType* null, null
  br i1 true, label %210, label %282

; <label>:210                                     ; preds = %205
  %211 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 6
  %212 = load %struct.stType*, %struct.stType** %211, align 8
  %213 = icmp eq i1 false, false
  %214 = icmp eq %struct.stType* null, null
  br i1 true, label %215, label %282

; <label>:215                                     ; preds = %210
  %216 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 7
  %217 = load %struct.stType*, %struct.stType** %216, align 8
  %218 = icmp eq i1 false, false
  %219 = icmp eq %struct.stType* null, null
  br i1 true, label %220, label %282

; <label>:220                                     ; preds = %215
  %221 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 8
  %222 = load %struct.stType*, %struct.stType** %221, align 8
  %223 = icmp eq i1 false, false
  %224 = icmp eq %struct.stType* null, null
  br i1 true, label %225, label %282

; <label>:225                                     ; preds = %220
  %226 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 9
  %227 = load %struct.stType*, %struct.stType** %226, align 8
  %228 = icmp eq i1 false, false
  %229 = icmp eq %struct.stType* null, null
  br i1 true, label %230, label %282

; <label>:230                                     ; preds = %225
  %231 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 10
  %232 = load %struct.stType*, %struct.stType** %231, align 8
  %233 = icmp eq i1 false, false
  %234 = icmp eq %struct.stType* null, null
  br i1 true, label %235, label %282

; <label>:235                                     ; preds = %230
  %236 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 11
  %237 = load %struct.stType*, %struct.stType** %236, align 8
  %238 = icmp eq i1 false, false
  %239 = icmp eq %struct.stType* null, null
  br i1 true, label %240, label %282

; <label>:240                                     ; preds = %235
  %241 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 12
  %242 = load %struct.stType*, %struct.stType** %241, align 8
  %243 = icmp eq i1 false, false
  %244 = icmp eq %struct.stType* null, null
  br i1 true, label %245, label %282

; <label>:245                                     ; preds = %240
  %246 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 13
  %247 = load %struct.stType*, %struct.stType** %246, align 8
  %248 = icmp eq i1 false, false
  %249 = icmp eq %struct.stType* null, null
  br i1 true, label %250, label %282

; <label>:250                                     ; preds = %245
  %251 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 14
  %252 = load %struct.stType*, %struct.stType** %251, align 8
  %253 = icmp eq i1 false, false
  %254 = icmp eq %struct.stType* null, null
  br i1 true, label %255, label %282

; <label>:255                                     ; preds = %250
  %256 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 15
  %257 = load %struct.stType*, %struct.stType** %256, align 8
  %258 = icmp eq i1 false, false
  %259 = icmp eq %struct.stType* null, null
  br i1 true, label %260, label %282

; <label>:260                                     ; preds = %255
  %261 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 16
  %262 = load %struct.stType*, %struct.stType** %261, align 8
  %263 = icmp eq i1 false, false
  %264 = icmp eq %struct.stType* null, null
  br i1 true, label %265, label %282

; <label>:265                                     ; preds = %260
  %266 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 17
  %267 = load %struct.stType*, %struct.stType** %266, align 8
  %268 = icmp eq i1 false, false
  %269 = icmp eq %struct.stType* null, null
  br i1 true, label %270, label %282

; <label>:270                                     ; preds = %265
  %271 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 18
  %272 = load %struct.stType*, %struct.stType** %271, align 8
  %273 = icmp eq i1 false, false
  %274 = icmp eq %struct.stType* null, null
  br i1 true, label %275, label %282

; <label>:275                                     ; preds = %270
  %276 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 19
  %277 = load %struct.stType*, %struct.stType** %276, align 8
  %278 = icmp eq i1 false, false
  %279 = icmp eq %struct.stType* null, null
  br i1 true, label %280, label %282

; <label>:280                                     ; preds = %275
  %281 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %282

; <label>:282                                     ; preds = %280, %275, %270, %265, %260, %255, %250, %245, %240, %235, %230, %225, %220, %215, %210, %205, %200, %192, %184, %175, %168, %159, %150, %142, %134, %125, %118, %109, %100, %92, %84, %75, %68, %59, %50, %42, %34, %25, %18, %9, %0
  ret void
}
