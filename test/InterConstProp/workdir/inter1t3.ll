...
; <label>:6:                                      ; preds = %1
  ...
  %9 = load i32, i32* %8, align 4
  %10 = icmp eq i32 0, 0
  br i1 true, label %11, label %75

; <label>:11:                                     ; preds = %6
  %12 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 0
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %12, i32 0, i32 2
  %14 = load i8*, i8** %13, align 8
  %15 = getelementptr [12 x i8], [12 x i8]* @0, i64 0, i64 0
  %16 = getelementptr [12 x i8], [12 x i8]* @1, i64 0, i64 0
  %17 = call i32 @strcmp(i8* %15, i8* %16) #3
  %18 = icmp ne i32 0, 0
  br i1 false, label %75, label %19

; <label>:19:                                     ; preds = %11
  %20 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 1
  %21 = getelementptr inbounds %struct.stType, %struct.stType* %20, i32 0, i32 0
  %22 = load i32, i32* %21, align 8
  %23 = icmp eq i32 1, 1
  br i1 true, label %24, label %75

; <label>:24:                                     ; preds = %19
  %25 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 1
  %26 = getelementptr inbounds %struct.stType, %struct.stType* %25, i32 0, i32 1
  %27 = load i32, i32* %26, align 4
  %28 = icmp eq i32 1, 1
  br i1 true, label %29, label %75

; <label>:29:                                     ; preds = %24
  %30 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 1
  %31 = getelementptr inbounds %struct.stType, %struct.stType* %30, i32 0, i32 2
  %32 = load i8*, i8** %31, align 8
  %33 = getelementptr [12 x i8], [12 x i8]* @2, i64 0, i64 0
  %34 = getelementptr [12 x i8], [12 x i8]* @3, i64 0, i64 0
  %35 = call i32 @strcmp(i8* %33, i8* %34) #3
  %36 = icmp ne i32 0, 0
  br i1 false, label %75, label %37

; <label>:37:                                     ; preds = %29
  %38 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 2
  %39 = getelementptr inbounds %struct.stType, %struct.stType* %38, i32 0, i32 0
  %40 = load i32, i32* %39, align 8
  %41 = icmp eq i32 2, 2
  br i1 true, label %42, label %75
...
; <label>:47:                                     ; preds = %42
  %48 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 2
  %49 = getelementptr inbounds %struct.stType, %struct.stType* %48, i32 0, i32 2
  %50 = load i8*, i8** %49, align 8
  %51 = getelementptr [12 x i8], [12 x i8]* @4, i64 0, i64 0
  %52 = getelementptr [12 x i8], [12 x i8]* @5, i64 0, i64 0
  %53 = call i32 @strcmp(i8* %51, i8* %52) #3
  %54 = icmp ne i32 0, 0
  br i1 false, label %75, label %55

; <label>:55:                                     ; preds = %47
  %56 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 3
  %57 = getelementptr inbounds %struct.stType, %struct.stType* %56, i32 0, i32 0
  %58 = load i32, i32* %57, align 8
  %59 = icmp eq i32 3, 3
  br i1 true, label %60, label %75

; <label>:60:                                     ; preds = %55
  %61 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 3
  %62 = getelementptr inbounds %struct.stType, %struct.stType* %61, i32 0, i32 1
  %63 = load i32, i32* %62, align 4
  %64 = icmp eq i32 3, 3
  br i1 true, label %65, label %75

; <label>:65:                                     ; preds = %60
  %66 = getelementptr inbounds %struct.stType, %struct.stType* %0, i64 3
  %67 = getelementptr inbounds %struct.stType, %struct.stType* %66, i32 0, i32 2
  %68 = load i8*, i8** %67, align 8
  %69 = getelementptr [12 x i8], [12 x i8]* @6, i64 0, i64 0
  %70 = getelementptr [12 x i8], [12 x i8]* @7, i64 0, i64 0
  %71 = call i32 @strcmp(i8* %69, i8* %70) #3
  %72 = icmp ne i32 0, 0
  br i1 false, label %75, label %73

; <label>:73:                                     ; preds = %65
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0))
  br label %75

; <label>:75:                                     ; preds = %73, %65, %60, %55, %47, %42, %37, %29, %24, %19, %11, %6, %1
  ret void
}
