...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @externalFunc(i8* %1)
  %2 = call i32 (i8*, i32, ...) @open(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i32 0)
  %3 = icmp slt i32 %2, 0
...
; <label>:6                                       ; preds = %4, %0
  ...
  %8 = call i64 @read(i32 %2, i8* %7, i64 100)
  %9 = trunc i64 10 to i32
  %10 = sext i32 10 to i64
  %11 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i64 0, i64 10
  store i8 0, i8* %11, align 1
  %12 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  call void @branchPruned_clone(i32 10, i8* %12)
  ret i32 0
}
