...
; <label>:158                                     ; preds = %127, %84
  ...
  call void @branchNotPruned_clone_clone(%struct.stType** %2)
  ret i32 0
}
...
; <label>:42                                      ; preds = %34
  ...
  br i1 true, label %50, label %92

; <label>:50                                      ; preds = %42
  %51 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  %52 = load %struct.stType*, %struct.stType** %51, align 8
  %53 = getelementptr inbounds %struct.stType, %struct.stType* %52, i32 0, i32 0
  %54 = load %struct.COORD*, %struct.COORD** %53, align 8
  ...
  %56 = load i32*, i32** %55, align 8
  %57 = load i32, i32* %56, align 4
  br i1 true, label %58, label %92

; <label>:58                                      ; preds = %50
  %59 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
...
; <label>:66                                      ; preds = %58
  ...
  br i1 true, label %72, label %92

; <label>:72                                      ; preds = %66
  %73 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  ...
  %77 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %92, label %78

; <label>:78                                      ; preds = %72
  %79 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %80 = load %struct.stType*, %struct.stType** %79, align 8
  %81 = getelementptr inbounds %struct.stType, %struct.stType* %80, i32 0, i32 1
  %82 = getelementptr inbounds [100 x i8], [100 x i8]* %81, i64 0, i64 4
...
; <label>:84                                      ; preds = %78
  ...
  %86 = load %struct.stType*, %struct.stType** %85, align 8
  %87 = getelementptr inbounds %struct.stType, %struct.stType* %86, i32 0, i32 1
  %88 = getelementptr inbounds [100 x i8], [100 x i8]* %87, i64 0, i64 9
  %89 = load i8, i8* %88, align 1
  br i1 true, label %90, label %92

; <label>:90                                      ; preds = %84
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %92

; <label>:92                                      ; preds = %90, %84, %78, %72, %66, %58, %50, %42, %34, %28, %22, %16, %8, %0
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone_clone(%struct.stType** %obj) #0 {
  %1 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 0
  %2 = load %struct.stType*, %struct.stType** %1, align 8
  %3 = getelementptr inbounds %struct.stType, %struct.stType* %2, i32 0, i32 2
  %4 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 1
