...
; <label>:18                                      ; preds = %9
  ...
  %24 = getelementptr [11 x i8], [11 x i8]* @1, i64 0, i64 0
  %25 = call i32 @strcmp(i8* %23, i8* %24) #5
  %26 = icmp ne i32 0, 0
  br i1 false, label %113, label %27

; <label>:27                                      ; preds = %18
  %28 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 0
  ...
  %33 = sext i8 111 to i32
  %34 = icmp eq i32 111, 111
  br i1 true, label %35, label %113

; <label>:35                                      ; preds = %27
  %36 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 0
  ...
  %41 = sext i8 100 to i32
  %42 = icmp eq i32 100, 100
  br i1 true, label %43, label %113

; <label>:43                                      ; preds = %35
  %44 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  ...
  %51 = icmp eq i32 11, 11
  br i1 true, label %52, label %113

; <label>:52                                      ; preds = %43
  %53 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  ...
  %60 = icmp eq i32 12, 12
  br i1 true, label %61, label %113

; <label>:61                                      ; preds = %52
  %62 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  ...
  %66 = getelementptr inbounds %struct.COORD, %struct.COORD* %65, i32 0, i32 0
  %67 = load i32*, i32** %66, align 8
  %68 = load i32, i32* %67, align 4
  %69 = icmp eq i32 16, 16
  br i1 true, label %70, label %113

; <label>:70                                      ; preds = %61
  %71 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
  ...
  %75 = getelementptr inbounds %struct.COORD, %struct.COORD* %74, i32 0, i32 1
  %76 = load i32*, i32** %75, align 8
  %77 = load i32, i32* %76, align 4
  %78 = icmp eq i32 17, 17
  br i1 true, label %79, label %113

; <label>:79                                      ; preds = %70
  %80 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %81 = load %struct.stType*, %struct.stType** %80, align 8
  %82 = getelementptr inbounds %struct.stType, %struct.stType* %81, i32 0, i32 2
  %83 = getelementptr inbounds [8 x i32], [8 x i32]* %82, i64 0, i64 1
  %84 = load i32, i32* %83, align 4
  %85 = icmp eq i32 14, 14
  br i1 true, label %86, label %113

; <label>:86                                      ; preds = %79
  %87 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %88 = load %struct.stType*, %struct.stType** %87, align 8
  %89 = getelementptr inbounds %struct.stType, %struct.stType* %88, i32 0, i32 1
  %90 = getelementptr inbounds [100 x i8], [100 x i8]* %89, i32 0, i32 0
  %91 = getelementptr [11 x i8], [11 x i8]* @2, i64 0, i64 0
  %92 = getelementptr [11 x i8], [11 x i8]* @3, i64 0, i64 0
  %93 = call i32 @strcmp(i8* %91, i8* %92) #5
  %94 = icmp ne i32 0, 0
  br i1 false, label %113, label %95

; <label>:95                                      ; preds = %86
  %96 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %97 = load %struct.stType*, %struct.stType** %96, align 8
  %98 = getelementptr inbounds %struct.stType, %struct.stType* %97, i32 0, i32 1
  %99 = getelementptr inbounds [100 x i8], [100 x i8]* %98, i64 0, i64 4
  %100 = load i8, i8* %99, align 4
  %101 = sext i8 111 to i32
  %102 = icmp eq i32 111, 111
  br i1 true, label %103, label %113

; <label>:103                                     ; preds = %95
  %104 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 2
  %105 = load %struct.stType*, %struct.stType** %104, align 8
  %106 = getelementptr inbounds %struct.stType, %struct.stType* %105, i32 0, i32 1
  %107 = getelementptr inbounds [100 x i8], [100 x i8]* %106, i64 0, i64 9
  %108 = load i8, i8* %107, align 1
  %109 = sext i8 100 to i32
  %110 = icmp eq i32 100, 100
  br i1 true, label %111, label %113

; <label>:111                                     ; preds = %103
  %112 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %113

; <label>:113                                     ; preds = %111, %103, %95, %86, %79, %70, %61, %52, %43, %35, %27, %18, %9, %0
  ret void
}
...
; <label>:14                                      ; preds = %7
  ...
  %17 = getelementptr inbounds %struct.stType, %struct.stType* %16, i32 0, i32 1
  %18 = getelementptr inbounds [100 x i8], [100 x i8]* %17, i32 0, i32 0
  %19 = getelementptr [11 x i8], [11 x i8]* @4, i64 0, i64 0
  %20 = call i32 @strcmp(i8* %18, i8* %19) #5
  %21 = icmp ne i32 %20, 0
  br i1 %21, label %22, label %38

; <label>:22                                      ; preds = %14
  %23 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
...
; <label>:30                                      ; preds = %22
  %31 = getelementptr inbounds %struct.stType*, %struct.stType** %obj, i64 3
