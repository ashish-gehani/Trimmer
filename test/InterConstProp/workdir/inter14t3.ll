...
; <label>:160:                                    ; preds = %129, %86
  ...
  call void @branchPruned_clone(%struct.stType** %4)
  call void @branchNotPruned_clone(%struct.stType** %4)
  ret i32 0
}
...
; <label>:19:                                     ; preds = %10
  ...
  %25 = getelementptr [11 x i8], [11 x i8]* @1, i64 0, i64 0
  %26 = call i32 @strcmp(i8* %24, i8* %25) #5
  %27 = icmp ne i32 0, 0
  br i1 false, label %114, label %28

; <label>:28:                                     ; preds = %19
  %29 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 0
  ...
  %34 = sext i8 111 to i32
  %35 = icmp eq i32 111, 111
  br i1 true, label %36, label %114

; <label>:36:                                     ; preds = %28
  %37 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 0
  %38 = load %struct.stType*, %struct.stType** %37, align 8
  ...
  %42 = sext i8 100 to i32
  %43 = icmp eq i32 100, 100
  br i1 true, label %44, label %114

; <label>:44:                                     ; preds = %36
  %45 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  ...
  br i1 true, label %53, label %114

; <label>:53:                                     ; preds = %44
  %54 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  %55 = load %struct.stType*, %struct.stType** %54, align 8
  %56 = getelementptr inbounds %struct.stType, %struct.stType* %55, i32 0, i32 0
  %57 = load %struct.COORD*, %struct.COORD** %56, align 8
  %58 = getelementptr inbounds %struct.COORD, %struct.COORD* %57, i32 0, i32 1
  %59 = load i32*, i32** %58, align 8
  %60 = load i32, i32* %59, align 4
  %61 = icmp eq i32 12, 12
  br i1 true, label %62, label %114

; <label>:62:                                     ; preds = %53
  %63 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 3
  %64 = load %struct.stType*, %struct.stType** %63, align 8
  %65 = getelementptr inbounds %struct.stType, %struct.stType* %64, i32 0, i32 0
  %66 = load %struct.COORD*, %struct.COORD** %65, align 8
  %67 = getelementptr inbounds %struct.COORD, %struct.COORD* %66, i32 0, i32 0
  %68 = load i32*, i32** %67, align 8
  %69 = load i32, i32* %68, align 4
  %70 = icmp eq i32 16, 16
  br i1 true, label %71, label %114

; <label>:71:                                     ; preds = %62
  %72 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 3
  %73 = load %struct.stType*, %struct.stType** %72, align 8
  %74 = getelementptr inbounds %struct.stType, %struct.stType* %73, i32 0, i32 0
  %75 = load %struct.COORD*, %struct.COORD** %74, align 8
  ...
  %79 = icmp eq i32 17, 17
  br i1 true, label %80, label %114

; <label>:80:                                     ; preds = %71
  %81 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  %82 = load %struct.stType*, %struct.stType** %81, align 8
  %83 = getelementptr inbounds %struct.stType, %struct.stType* %82, i32 0, i32 2
  %84 = getelementptr inbounds [8 x i32], [8 x i32]* %83, i64 0, i64 1
  %85 = load i32, i32* %84, align 4
  %86 = icmp eq i32 14, 14
  br i1 true, label %87, label %114

; <label>:87:                                     ; preds = %80
  %88 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  ...
  %92 = getelementptr [11 x i8], [11 x i8]* @2, i64 0, i64 0
  %93 = getelementptr [11 x i8], [11 x i8]* @3, i64 0, i64 0
  %94 = call i32 @strcmp(i8* %92, i8* %93) #5
  %95 = icmp ne i32 0, 0
  br i1 false, label %114, label %96

; <label>:96:                                     ; preds = %87
  %97 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  %98 = load %struct.stType*, %struct.stType** %97, align 8
  %99 = getelementptr inbounds %struct.stType, %struct.stType* %98, i32 0, i32 1
  %100 = getelementptr inbounds [100 x i8], [100 x i8]* %99, i64 0, i64 4
  %101 = load i8, i8* %100, align 4
  %102 = sext i8 111 to i32
  %103 = icmp eq i32 111, 111
  br i1 true, label %104, label %114

; <label>:104:                                    ; preds = %96
  %105 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 2
  %106 = load %struct.stType*, %struct.stType** %105, align 8
  %107 = getelementptr inbounds %struct.stType, %struct.stType* %106, i32 0, i32 1
  %108 = getelementptr inbounds [100 x i8], [100 x i8]* %107, i64 0, i64 9
  %109 = load i8, i8* %108, align 1
  %110 = sext i8 100 to i32
  %111 = icmp eq i32 100, 100
  br i1 true, label %112, label %114

; <label>:112:                                    ; preds = %104
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %114

; <label>:114:                                    ; preds = %112, %104, %96, %87, %80, %71, %62, %53, %44, %36, %28, %19, %10, %1
  ret void
}

; Function Attrs: noinline nounwind uwtable
define void @branchNotPruned_clone(%struct.stType**) #0 {
  %2 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 0
  %3 = load %struct.stType*, %struct.stType** %2, align 8
  %4 = getelementptr inbounds %struct.stType, %struct.stType* %3, i32 0, i32 2
  %5 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 1
...
; <label>:15:                                     ; preds = %8
  ...
  %18 = getelementptr inbounds %struct.stType, %struct.stType* %17, i32 0, i32 1
  %19 = getelementptr inbounds [100 x i8], [100 x i8]* %18, i32 0, i32 0
  %20 = getelementptr [11 x i8], [11 x i8]* @4, i64 0, i64 0
  %21 = call i32 @strcmp(i8* %19, i8* %20) #5
  %22 = icmp ne i32 %21, 0
  br i1 %22, label %23, label %39

; <label>:23:                                     ; preds = %15
  %24 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 3
  %25 = load %struct.stType*, %struct.stType** %24, align 8
  %26 = getelementptr inbounds %struct.stType, %struct.stType* %25, i32 0, i32 1
  %27 = getelementptr inbounds [100 x i8], [100 x i8]* %26, i64 0, i64 4
...
; <label>:31:                                     ; preds = %23
  %32 = getelementptr inbounds %struct.stType*, %struct.stType** %0, i64 3
  %33 = load %struct.stType*, %struct.stType** %32, align 8
  %34 = getelementptr inbounds %struct.stType, %struct.stType* %33, i32 0, i32 1
  %35 = getelementptr inbounds [100 x i8], [100 x i8]* %34, i64 0, i64 9
  %36 = load i8, i8* %35, align 1
  %37 = sext i8 %36 to i32
  %38 = icmp eq i32 %37, 100
  br i1 %38, label %39, label %41

; <label>:39:                                     ; preds = %31, %23, %15, %8, %1
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0))
  br label %41
