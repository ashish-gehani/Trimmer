...
.lr.ph:                                           ; preds = %0, %50
  %.015 = phi %struct.Node* [ %55, %50 ], [ %2, %0 ]
  %.024 = phi i32 [ %56, %50 ], [ 1, %0 ]
  %37 = getelementptr inbounds %struct.Node, %struct.Node* %.015, i32 0, i32 0
  store i32 %.024, i32* %37, align 8
  %38 = call noalias i8* @malloc(i64 11) #5
  %39 = getelementptr inbounds %struct.Node, %struct.Node* %.015, i32 0, i32 1
  store i8* %38, i8** %39, align 8
  br label %40

; <label>:40:                                     ; preds = %.lr.ph, %40
  %.03 = phi i32 [ 0, %.lr.ph ], [ %48, %40 ]
  %41 = add nsw i32 97, %.024
  %42 = add nsw i32 %41, %.03
  %43 = trunc i32 %42 to i8
  %44 = getelementptr inbounds %struct.Node, %struct.Node* %.015, i32 0, i32 1
...
; <label>:50:                                     ; preds = %40
  %51 = getelementptr inbounds %struct.Node, %struct.Node* %.015, i32 0, i32 1
  %52 = load i8*, i8** %51, align 8
  %53 = getelementptr inbounds i8, i8* %52, i64 10
  store i8 0, i8* %53, align 1
  %54 = getelementptr inbounds %struct.Node, %struct.Node* %.015, i32 0, i32 2
