...
@.str.3 = private unnamed_addr constant [12 x i8] c"helloWorld\00\00", align 8
...
; <label>:4                                       ; preds = %0
  %5 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 2, i64 1
  %6 = load i32, i32* %5, align 4
  %7 = icmp eq i32 %6, 12
  br i1 %7, label %8, label %21

; <label>:8                                       ; preds = %4
  %9 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 1, i64 0
  %10 = call i32 @strcmp(i8* %9, i8* nonnull getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0)) #5
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %12, label %21

; <label>:12                                      ; preds = %8
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 1, i64 4
  %14 = load i8, i8* %13, align 4
  %15 = icmp eq i8 %14, 111
  br i1 %15, label %16, label %21

; <label>:16                                      ; preds = %12
  %17 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 1, i64 9
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned(%struct.stType* byval nocapture readonly align 8 %obj) #0 {
...
; <label>:8                                       ; preds = %4, %0
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([6 x i8], [6 x i8]* @str.2, i64 0, i64 0))
  br label %9
...
define void @initialize(%struct.stType* nocapture %obj) #2 {
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i64 0, i64 0), i64 11, i32 1, i1 false)
  ret void
}
...
branchNotPruned.exit:
  %puts.i3 = tail call i32 @puts(i8* nonnull getelementptr inbounds ([6 x i8], [6 x i8]* @str.2, i64 0, i64 0)) #4
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.3, i64 0, i64 0)) #4
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone(%struct.stType* byval nocapture readonly align 8 %obj) #0 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 2, i64 6
  %2 = load i32, i32* %1, align 4
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %8, label %4
...
define void @branchPruned_clone(%struct.stType* byval nocapture readnone align 8 %obj) #0 {
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.3, i64 0, i64 0))
  ret void
}
...
; Function Attrs: norecurse nounwind uwtable
define void @initialize_clone.4(%struct.stType* nocapture %obj) #2 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 0, i32 0
  store i32 4, i32* %1, align 4
  %2 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 0, i32 1
  store i32 8, i32* %2, align 4
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone.5(%struct.stType* byval nocapture readonly align 8 %obj) #0 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %obj, i64 0, i32 2, i64 6
  %2 = load i32, i32* %1, align 4
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %8, label %4
