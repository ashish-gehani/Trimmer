...
@.str.2 = private unnamed_addr constant [12 x i8] c"helloWorld\00\00", align 8
...
; <label>:20                                      ; preds = %16
  %puts = tail call i32 @puts(i8* nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @str.1, i64 0, i64 0))
  br label %21
...
define void @initialize(%struct.stType* nocapture %obj) #2 {
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i64 11, i32 1, i1 false)
  ret void
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.1, i64 0, i64 0)) #4
  ret i32 0
}
