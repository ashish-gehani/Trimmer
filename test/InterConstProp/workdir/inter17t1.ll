...
define void @initialize(%struct.stType* %obj) #0 {
  ...
  %4 = getelementptr inbounds %struct.COORD, %struct.COORD* %3, i32 0, i32 0
  store i32 4, i32* %4, align 4
  %5 = load %struct.stType*, %struct.stType** %1, align 8
  ...
  %9 = getelementptr inbounds %struct.stType, %struct.stType* %8, i32 0, i32 2
  %10 = getelementptr inbounds [8 x i32], [8 x i32]* %9, i64 0, i64 0
  store i32 12, i32* %10, align 4
  %11 = load %struct.stType*, %struct.stType** %1, align 8
  ...
  %15 = getelementptr inbounds %struct.stType, %struct.stType* %14, i32 0, i32 2
  %16 = getelementptr inbounds [8 x i32], [8 x i32]* %15, i64 0, i64 2
  store i32 12, i32* %16, align 4
  %17 = load %struct.stType*, %struct.stType** %1, align 8
  %18 = getelementptr inbounds %struct.stType, %struct.stType* %17, i32 0, i32 1
  %19 = getelementptr inbounds [100 x i8], [100 x i8]* %18, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i64 11, i32 1, i1 false)
  ret void
}
