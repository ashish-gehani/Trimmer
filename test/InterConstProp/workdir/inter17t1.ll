...
define void @initialize(%struct.stType*) #0 {
  ...
  %6 = load %struct.stType*, %struct.stType** %2, align 8
  %7 = getelementptr inbounds %struct.stType, %struct.stType* %6, i32 0, i32 0
  ...
  %12 = load %struct.stType*, %struct.stType** %2, align 8
  ...
  %18 = load %struct.stType*, %struct.stType** %2, align 8
  %19 = getelementptr inbounds %struct.stType, %struct.stType* %18, i32 0, i32 1
  %20 = getelementptr inbounds [100 x i8], [100 x i8]* %19, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %20, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i64 11, i32 1, i1 false)
  ret void
}
...
define i32 @main() #0 {
  ...
  call void @initialize(%struct.stType* %2)
  call void @branchPruned(%struct.stType* byval align 8 %2)
  ret i32 0
}
