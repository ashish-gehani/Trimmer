...
; <label>:101                                     ; preds = %73, %34
  ...
  br i1 %192, label %193, label %branchNotPruned_clone_clone.exit
...
; <label>:193                                     ; preds = %101
  ...
  br i1 %201, label %202, label %branchNotPruned_clone_clone.exit
...
; <label>:202                                     ; preds = %193
  ...
  br i1 %206, label %207, label %branchNotPruned_clone_clone.exit

; <label>:207                                     ; preds = %202
  %208 = getelementptr inbounds %struct.stType, %struct.stType* %195, i64 0, i32 2, i64 1
  %209 = load i32, i32* %208, align 4
  %210 = icmp eq i32 %209, 19
  br i1 %210, label %211, label %branchNotPruned_clone_clone.exit
...
; <label>:211                                     ; preds = %207
  ...
  br i1 %214, label %215, label %branchNotPruned_clone_clone.exit
...
; <label>:215                                     ; preds = %211
  ...
  br i1 %218, label %219, label %branchNotPruned_clone_clone.exit

; <label>:219                                     ; preds = %215
  %220 = getelementptr inbounds %struct.stType, %struct.stType* %195, i64 0, i32 1, i64 9
  %221 = load i8, i8* %220, align 1
  %222 = icmp eq i8 %221, 100
  br i1 %222, label %223, label %branchNotPruned_clone_clone.exit
...
branchNotPruned_clone_clone.exit:                 ; preds = %101, %193, %202, %207, %211, %215, %219, %223
  ret i32 0
}
