...
; <label>:14                                      ; preds = %9, %4
  call void @branchPruned_clone_clone(%struct.stType* %st)
  call void @branchNotPruned_clone_clone(%struct.stType* %st)
  ret i32 0
}
...
; <label>:4                                       ; preds = %0
  %5 = getelementptr inbounds %struct.stType, %struct.stType* %st, i32 0, i32 1
  %6 = getelementptr inbounds [8 x i32], [8 x i32]* %5, i64 0, i64 7
  %7 = load i32, i32* %6, align 4
  br i1 true, label %8, label %10

; <label>:8                                       ; preds = %4
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0))
  br label %10
...
; <label>:17                                      ; preds = %15, %11, %5, %0
  ret void
}

; Function Attrs: nounwind uwtable
define void @branchPruned_clone_clone(%struct.stType* byval align 8 %st) #0 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %st, i32 0, i32 1
  %2 = getelementptr inbounds [8 x i32], [8 x i32]* %1, i64 0, i64 0
  %3 = load i32, i32* %2, align 4
  br i1 true, label %4, label %10
...
; Function Attrs: nounwind uwtable
define void @branchNotPruned_clone_clone(%struct.stType* byval align 8 %st) #0 {
  %1 = getelementptr inbounds %struct.stType, %struct.stType* %st, i32 0, i32 0
  %2 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i32 0, i32 0
  %3 = call i32 @strcmp(i8* %2, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0)) #4
  %4 = icmp ne i32 %3, 0
