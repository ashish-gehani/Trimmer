...
; <label>:14                                      ; preds = %9, %4
  call void @branchPruned_clone(%struct.stType* %st)
  call void @branchNotPruned_clone(%struct.stType* %st)
  ret i32 0
}
...
; <label>:6                                       ; preds = %0
  ...
  %10 = sext i8 111 to i32
  %11 = icmp eq i32 111, 111
  br i1 true, label %12, label %20

; <label>:12                                      ; preds = %6
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %st, i32 0, i32 0
  %14 = getelementptr inbounds [100 x i8], [100 x i8]* %13, i64 0, i64 9
  %15 = load i8, i8* %14, align 1
  %16 = sext i8 100 to i32
  %17 = icmp eq i32 100, 100
