...
; <label>:13                                      ; preds = %7
  ...
  %18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0)) #5
  %19 = icmp ne i32 %18, 0
...
; <label>:32                                      ; preds = %26
  ...
  %37 = call i32 @strcmp(i8* %36, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0)) #5
  %38 = icmp ne i32 %37, 0
...
; <label>:51                                      ; preds = %45
  ...
  %56 = call i32 @strcmp(i8* %55, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0)) #5
  %57 = icmp ne i32 %56, 0
...
; <label>:70                                      ; preds = %64
  ...
  %75 = call i32 @strcmp(i8* %74, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)) #5
  %76 = icmp ne i32 %75, 0
...
define void @init0(%struct.stType* %st) #0 {
  ...
  %4 = load %struct.stType*, %struct.stType** %1, align 8
  %5 = getelementptr inbounds %struct.stType, %struct.stType* %4, i32 0, i32 1
  store i32 0, i32* %5, align 4
  %6 = call noalias i8* @malloc(i64 100) #6
  %7 = load %struct.stType*, %struct.stType** %1, align 8
  %8 = getelementptr inbounds %struct.stType, %struct.stType* %7, i32 0, i32 2
  store i8* %6, i8** %8, align 8
  %9 = load %struct.stType*, %struct.stType** %1, align 8
  %10 = getelementptr inbounds %struct.stType, %struct.stType* %9, i32 0, i32 2
  %11 = load i8*, i8** %10, align 8
  call void @llvm.memset.p0i8.i64(i8* %11, i8 0, i64 100, i32 1, i1 false)
  %12 = load %struct.stType*, %struct.stType** %1, align 8
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %12, i32 0, i32 2
  %14 = load i8*, i8** %13, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
...
define void @init1(%struct.stType* %st) #0 {
  ...
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %12, i32 0, i32 2
  %14 = load i8*, i8** %13, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
...
define void @init2(%struct.stType* %st) #0 {
  ...
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %12, i32 0, i32 2
  %14 = load i8*, i8** %13, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
...
define void @init3(%struct.stType* %st) #0 {
  ...
  %13 = getelementptr inbounds %struct.stType, %struct.stType* %12, i32 0, i32 2
  %14 = load i8*, i8** %13, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i64 100, i32 1, i1 false)
  ret void
}
...
define i32 @main() #0 {
  ...
  %2 = load void (%struct.stType*)*, void (%struct.stType*)** bitcast ({}** getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 0, i32 3) to void (%struct.stType*)**), align 16
  call void %2(%struct.stType* getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 0))
  %3 = load void (%struct.stType*)*, void (%struct.stType*)** bitcast ({}** getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 1, i32 3) to void (%struct.stType*)**), align 8
  call void %3(%struct.stType* getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 1))
  %4 = load void (%struct.stType*)*, void (%struct.stType*)** bitcast ({}** getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 2, i32 3) to void (%struct.stType*)**), align 16
  call void %4(%struct.stType* getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 2))
  %5 = load void (%struct.stType*)*, void (%struct.stType*)** bitcast ({}** getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 3, i32 3) to void (%struct.stType*)**), align 8
  call void %5(%struct.stType* getelementptr inbounds ([4 x %struct.stType], [4 x %struct.stType]* bitcast (<{ { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* }, { i32, i32, i8*, void (%struct.stType*)* } }>* @st to [4 x %struct.stType]*), i64 0, i64 3))
