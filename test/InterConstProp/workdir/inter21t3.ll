...
define void @branchPruned_clone() #0 {
  ...
  %3 = call i64 @strcspn(i8* %1, i8* %2) #4
  %4 = trunc i64 2 to i32
  %5 = sext i32 2 to i64
  %6 = getelementptr inbounds i8, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i32 0, i32 0), i64 2
  %7 = getelementptr inbounds i8, i8* %6, i32 1
  store i8 0, i8* %6, align 1
  %8 = getelementptr [7 x i8], [7 x i8]* @2, i64 0, i64 0
  %9 = getelementptr [7 x i8], [7 x i8]* @3, i64 0, i64 0
  %10 = call i32 @strcmp(i8* %8, i8* %9) #4
  %11 = icmp eq i32 0, 0
  br i1 true, label %12, label %16

; <label>:12:                                     ; preds = %0
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i32 0, i32 0))
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* %7)
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0))
  br label %16
