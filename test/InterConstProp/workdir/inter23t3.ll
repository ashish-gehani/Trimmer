...
; <label>:9                                       ; preds = %0
  ...
  br i1 true, label %18, label %87

; <label>:18                                      ; preds = %9
  %19 = load %struct.stType**, %struct.stType*** @obj, align 8
  %20 = getelementptr inbounds %struct.stType*, %struct.stType** %19, i64 0
  %21 = load %struct.stType*, %struct.stType** %20, align 8
  %22 = getelementptr inbounds %struct.stType, %struct.stType* %21, i32 0, i32 1
  %23 = getelementptr inbounds [100 x i8], [100 x i8]* %22, i32 0, i32 0
  %24 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %87, label %25
...
; <label>:25                                      ; preds = %18
  ...
  br i1 true, label %32, label %87

; <label>:32                                      ; preds = %25
  %33 = load %struct.stType**, %struct.stType*** @obj, align 8
  %34 = getelementptr inbounds %struct.stType*, %struct.stType** %33, i64 0
...
; <label>:57                                      ; preds = %48
  ...
  br i1 true, label %64, label %87

; <label>:64                                      ; preds = %57
  %65 = load %struct.stType**, %struct.stType*** @obj, align 8
  %66 = getelementptr inbounds %struct.stType*, %struct.stType** %65, i64 2
  ...
  %70 = call i32 @strcmp(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #5
  br i1 false, label %87, label %71

; <label>:71                                      ; preds = %64
  %72 = load %struct.stType**, %struct.stType*** @obj, align 8
  %73 = getelementptr inbounds %struct.stType*, %struct.stType** %72, i64 2
  %74 = load %struct.stType*, %struct.stType** %73, align 8
  %75 = getelementptr inbounds %struct.stType, %struct.stType* %74, i32 0, i32 1
  %76 = getelementptr inbounds [100 x i8], [100 x i8]* %75, i64 0, i64 4
  %77 = load i8, i8* %76, align 4
  br i1 true, label %78, label %87

; <label>:78                                      ; preds = %71
  %79 = load %struct.stType**, %struct.stType*** @obj, align 8
  %80 = getelementptr inbounds %struct.stType*, %struct.stType** %79, i64 2
  %81 = load %struct.stType*, %struct.stType** %80, align 8
  %82 = getelementptr inbounds %struct.stType, %struct.stType* %81, i32 0, i32 1
  %83 = getelementptr inbounds [100 x i8], [100 x i8]* %82, i64 0, i64 9
  %84 = load i8, i8* %83, align 1
  br i1 true, label %85, label %87

; <label>:85                                      ; preds = %78
  %86 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %87

; <label>:87                                      ; preds = %85, %78, %71, %64, %57, %48, %39, %32, %25, %18, %9, %0
  ret void
}
