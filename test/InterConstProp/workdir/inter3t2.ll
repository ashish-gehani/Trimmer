...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i64 100, i32 1, i1 false)
...
define void @branchPruned_clone(i8* %buf) #0 {
  ...
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds i8, i8* %buf, i64 %4
...
; <label>:9                                       ; preds = %0
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* %buf)
