...
; <label>:191                                     ; preds = %184
  %192 = getelementptr inbounds %struct.HighType, %struct.HighType* %obj, i32 0, i32 0
  ...
  %195 = getelementptr [4 x i8], [4 x i8]* @1, i64 0, i64 0
  %196 = call i32 @strcmp(i8* %195, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0)) #4
  %197 = icmp ne i32 0, 0
  br i1 %197, label %221, label %198

; <label>:198                                     ; preds = %191
  %199 = getelementptr inbounds %struct.HighType, %struct.HighType* %obj, i32 0, i32 0
  %200 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %199, i32 0, i32 0
  %201 = getelementptr inbounds [1000 x i8], [1000 x i8]* %200, i64 0, i64 131
  %202 = getelementptr [6 x i8], [6 x i8]* @2, i64 0, i64 0
  %203 = call i32 @strcmp(i8* %202, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0)) #4
  %204 = icmp ne i32 0, 0
  br i1 %204, label %221, label %205

; <label>:205                                     ; preds = %198
  %206 = getelementptr inbounds %struct.HighType, %struct.HighType* %obj, i32 0, i32 0
  %207 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %206, i32 0, i32 0
  %208 = getelementptr inbounds [1000 x i8], [1000 x i8]* %207, i64 0, i64 253
  %209 = getelementptr [6 x i8], [6 x i8]* @3, i64 0, i64 0
  %210 = call i32 @strcmp(i8* %209, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0)) #4
  %211 = icmp ne i32 0, 0
  br i1 %211, label %221, label %212

; <label>:212                                     ; preds = %205
  %213 = getelementptr inbounds %struct.HighType, %struct.HighType* %obj, i32 0, i32 0
  %214 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %213, i32 0, i32 0
  %215 = getelementptr inbounds [1000 x i8], [1000 x i8]* %214, i64 0, i64 276
  %216 = getelementptr [5 x i8], [5 x i8]* @4, i64 0, i64 0
  %217 = call i32 @strcmp(i8* %216, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0)) #4
  %218 = icmp ne i32 0, 0
  br i1 %218, label %221, label %219

; <label>:219                                     ; preds = %212
  %220 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i32 0, i32 0))
  br label %221

; <label>:221                                     ; preds = %219, %212, %205, %198, %191, %184, %178, %172, %166, %160, %154, %147, %140, %133, %126, %119, %112, %105, %98, %91, %84, %77, %70, %63, %56, %49, %42, %35, %28, %21, %14, %7, %0
  ret void
}
