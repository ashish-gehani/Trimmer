...
define void @branchPruned_clone(%struct.HighType* byval align 8) #0 {
  ...
  %4 = getelementptr inbounds [1000 x i8], [1000 x i8]* %3, i64 0, i64 225
  %5 = load i8, i8* %4, align 1
  %6 = sext i8 111 to i32
  %7 = icmp eq i32 111, 111
  br i1 true, label %8, label %227
...
; <label>:8:                                      ; preds = %1
  ...
  %11 = getelementptr inbounds [1000 x i8], [1000 x i8]* %10, i64 0, i64 226
  %12 = load i8, i8* %11, align 2
  %13 = sext i8 113 to i32
  %14 = icmp eq i32 113, 113
  br i1 true, label %15, label %227
...
; <label>:15:                                     ; preds = %8
  ...
  %18 = getelementptr inbounds [1000 x i8], [1000 x i8]* %17, i64 0, i64 227
  %19 = load i8, i8* %18, align 1
  %20 = sext i8 109 to i32
  %21 = icmp eq i32 109, 109
  br i1 true, label %22, label %227
...
; <label>:29:                                     ; preds = %22
  ...
  %32 = getelementptr inbounds [1000 x i8], [1000 x i8]* %31, i64 0, i64 229
  %33 = load i8, i8* %32, align 1
  %34 = sext i8 112 to i32
  %35 = icmp eq i32 112, 112
  br i1 true, label %36, label %227
...
; <label>:36:                                     ; preds = %29
  ...
  %39 = getelementptr inbounds [1000 x i8], [1000 x i8]* %38, i64 0, i64 131
  %40 = load i8, i8* %39, align 1
  %41 = sext i8 97 to i32
  %42 = icmp eq i32 97, 97
  br i1 true, label %43, label %227
...
; <label>:43:                                     ; preds = %36
  ...
  %46 = getelementptr inbounds [1000 x i8], [1000 x i8]* %45, i64 0, i64 132
  %47 = load i8, i8* %46, align 4
  %48 = sext i8 102 to i32
  %49 = icmp eq i32 102, 102
  br i1 true, label %50, label %227
...
; <label>:50:                                     ; preds = %43
  ...
  %53 = getelementptr inbounds [1000 x i8], [1000 x i8]* %52, i64 0, i64 133
  %54 = load i8, i8* %53, align 1
  %55 = sext i8 119 to i32
  %56 = icmp eq i32 119, 119
  br i1 true, label %57, label %227
...
; <label>:57:                                     ; preds = %50
  ...
  %60 = getelementptr inbounds [1000 x i8], [1000 x i8]* %59, i64 0, i64 134
  %61 = load i8, i8* %60, align 2
  %62 = sext i8 105 to i32
  %63 = icmp eq i32 105, 105
  br i1 true, label %64, label %227
...
; <label>:64:                                     ; preds = %57
  ...
  %67 = getelementptr inbounds [1000 x i8], [1000 x i8]* %66, i64 0, i64 135
  %68 = load i8, i8* %67, align 1
  %69 = sext i8 107 to i32
  %70 = icmp eq i32 107, 107
  br i1 true, label %71, label %227
...
; <label>:71:                                     ; preds = %64
  ...
  %74 = getelementptr inbounds [1000 x i8], [1000 x i8]* %73, i64 0, i64 253
  %75 = load i8, i8* %74, align 1
  %76 = sext i8 120 to i32
  %77 = icmp eq i32 120, 120
  br i1 true, label %78, label %227
...
; <label>:78:                                     ; preds = %71
  ...
  %81 = getelementptr inbounds [1000 x i8], [1000 x i8]* %80, i64 0, i64 254
  %82 = load i8, i8* %81, align 2
  %83 = sext i8 97 to i32
  %84 = icmp eq i32 97, 97
  br i1 true, label %85, label %227
...
; <label>:85:                                     ; preds = %78
  ...
  %88 = getelementptr inbounds [1000 x i8], [1000 x i8]* %87, i64 0, i64 255
  %89 = load i8, i8* %88, align 1
  %90 = sext i8 119 to i32
  %91 = icmp eq i32 119, 119
  br i1 true, label %92, label %227
...
; <label>:92:                                     ; preds = %85
  ...
  %95 = getelementptr inbounds [1000 x i8], [1000 x i8]* %94, i64 0, i64 256
  %96 = load i8, i8* %95, align 8
  %97 = sext i8 106 to i32
  %98 = icmp eq i32 106, 106
  br i1 true, label %99, label %227
...
; <label>:99:                                     ; preds = %92
  ...
  br i1 true, label %106, label %227
...
; <label>:106:                                    ; preds = %99
  ...
  br i1 true, label %113, label %227
...
; <label>:113:                                    ; preds = %106
  ...
  %116 = getelementptr inbounds [1000 x i8], [1000 x i8]* %115, i64 0, i64 277
  %117 = load i8, i8* %116, align 1
  %118 = sext i8 101 to i32
  %119 = icmp eq i32 101, 101
  br i1 true, label %120, label %227
...
; <label>:120:                                    ; preds = %113
  ...
  %123 = getelementptr inbounds [1000 x i8], [1000 x i8]* %122, i64 0, i64 278
  %124 = load i8, i8* %123, align 2
  %125 = sext i8 97 to i32
  %126 = icmp eq i32 97, 97
  br i1 true, label %127, label %227
...
; <label>:127:                                    ; preds = %120
  ...
  %130 = getelementptr inbounds [1000 x i8], [1000 x i8]* %129, i64 0, i64 279
  %131 = load i8, i8* %130, align 1
  %132 = sext i8 106 to i32
  %133 = icmp eq i32 106, 106
  br i1 true, label %134, label %227
...
; <label>:134:                                    ; preds = %127
  ...
  %137 = getelementptr inbounds [1000 x i8], [1000 x i8]* %136, i64 0, i64 645
  %138 = load i8, i8* %137, align 1
  %139 = sext i8 121 to i32
  %140 = icmp eq i32 121, 121
  br i1 true, label %141, label %227
...
; <label>:141:                                    ; preds = %134
  ...
  %144 = getelementptr inbounds [1000 x i8], [1000 x i8]* %143, i64 0, i64 646
  %145 = load i8, i8* %144, align 2
  %146 = sext i8 103 to i32
  %147 = icmp eq i32 103, 103
  br i1 true, label %148, label %227
...
; <label>:148:                                    ; preds = %141
  ...
  %151 = getelementptr inbounds [1000 x i8], [1000 x i8]* %150, i64 0, i64 647
  %152 = load i8, i8* %151, align 1
  %153 = sext i8 120 to i32
  %154 = icmp eq i32 120, 120
  br i1 true, label %155, label %227
...
; <label>:155:                                    ; preds = %148
  ...
  %158 = getelementptr inbounds [1000 x i32], [1000 x i32]* %157, i64 0, i64 335
  %159 = load i32, i32* %158, align 4
  %160 = icmp eq i32 112, 112
  br i1 true, label %161, label %227
...
; <label>:161:                                    ; preds = %155
  ...
  %164 = getelementptr inbounds [1000 x i32], [1000 x i32]* %163, i64 0, i64 534
  %165 = load i32, i32* %164, align 8
  %166 = icmp eq i32 106, 106
  br i1 true, label %167, label %227
...
; <label>:167:                                    ; preds = %161
  ...
  %170 = getelementptr inbounds [1000 x i32], [1000 x i32]* %169, i64 0, i64 569
  %171 = load i32, i32* %170, align 4
  %172 = icmp eq i32 122, 122
  br i1 true, label %173, label %227
...
; <label>:173:                                    ; preds = %167
  ...
  %176 = getelementptr inbounds [1000 x i32], [1000 x i32]* %175, i64 0, i64 649
  %177 = load i32, i32* %176, align 4
  %178 = icmp eq i32 116, 116
  br i1 true, label %179, label %227
...
; <label>:179:                                    ; preds = %173
  ...
  %182 = getelementptr inbounds [1000 x i32], [1000 x i32]* %181, i64 0, i64 987
  %183 = load i32, i32* %182, align 4
  %184 = icmp eq i32 121, 121
  br i1 true, label %185, label %227

; <label>:185:                                    ; preds = %179
  %186 = getelementptr inbounds %struct.HighType, %struct.HighType* %0, i32 0, i32 0
  %187 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %186, i32 0, i32 1
  %188 = getelementptr inbounds [1000 x i8], [1000 x i8]* %187, i64 0, i64 225
  %189 = getelementptr [6 x i8], [6 x i8]* @0, i64 0, i64 0
  %190 = getelementptr [6 x i8], [6 x i8]* @1, i64 0, i64 0
  %191 = call i32 @strcmp(i8* %189, i8* %190) #4
  %192 = icmp ne i32 0, 0
  br i1 false, label %227, label %193

; <label>:193:                                    ; preds = %185
  %194 = getelementptr inbounds %struct.HighType, %struct.HighType* %0, i32 0, i32 0
  %195 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %194, i32 0, i32 0
  %196 = getelementptr inbounds [1000 x i8], [1000 x i8]* %195, i64 0, i64 645
  %197 = getelementptr [4 x i8], [4 x i8]* @2, i64 0, i64 0
  %198 = getelementptr [4 x i8], [4 x i8]* @3, i64 0, i64 0
  %199 = call i32 @strcmp(i8* %197, i8* %198) #4
  %200 = icmp ne i32 0, 0
  br i1 false, label %227, label %201

; <label>:201:                                    ; preds = %193
  %202 = getelementptr inbounds %struct.HighType, %struct.HighType* %0, i32 0, i32 0
  %203 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %202, i32 0, i32 0
  %204 = getelementptr inbounds [1000 x i8], [1000 x i8]* %203, i64 0, i64 131
  %205 = getelementptr [6 x i8], [6 x i8]* @4, i64 0, i64 0
  %206 = getelementptr [6 x i8], [6 x i8]* @5, i64 0, i64 0
  %207 = call i32 @strcmp(i8* %205, i8* %206) #4
  %208 = icmp ne i32 0, 0
  br i1 false, label %227, label %209

; <label>:209:                                    ; preds = %201
  %210 = getelementptr inbounds %struct.HighType, %struct.HighType* %0, i32 0, i32 0
  %211 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %210, i32 0, i32 0
  %212 = getelementptr inbounds [1000 x i8], [1000 x i8]* %211, i64 0, i64 253
  %213 = getelementptr [6 x i8], [6 x i8]* @6, i64 0, i64 0
  %214 = getelementptr [6 x i8], [6 x i8]* @7, i64 0, i64 0
  %215 = call i32 @strcmp(i8* %213, i8* %214) #4
  %216 = icmp ne i32 0, 0
  br i1 false, label %227, label %217

; <label>:217:                                    ; preds = %209
  %218 = getelementptr inbounds %struct.HighType, %struct.HighType* %0, i32 0, i32 0
  %219 = getelementptr inbounds %struct.LowTypeString, %struct.LowTypeString* %218, i32 0, i32 0
  %220 = getelementptr inbounds [1000 x i8], [1000 x i8]* %219, i64 0, i64 276
  %221 = getelementptr [5 x i8], [5 x i8]* @8, i64 0, i64 0
  %222 = getelementptr [5 x i8], [5 x i8]* @9, i64 0, i64 0
  %223 = call i32 @strcmp(i8* %221, i8* %222) #4
  %224 = icmp ne i32 0, 0
  br i1 false, label %227, label %225

; <label>:225:                                    ; preds = %217
  %226 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i32 0, i32 0))
  br label %227

; <label>:227:                                    ; preds = %225, %217, %209, %201, %193, %185, %179, %173, %167, %161, %155, %148, %141, %134, %127, %120, %113, %106, %99, %92, %85, %78, %71, %64, %57, %50, %43, %36, %29, %22, %15, %8, %1
  ret void
}
