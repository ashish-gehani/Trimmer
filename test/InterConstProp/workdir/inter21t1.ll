...
define void @branchPruned() #0 {
  ...
  store i8* %7, i8** %value, align 8
  store i8 0, i8* %6, align 1
  %8 = load i8*, i8** %value, align 8
  %9 = call i32 @strcmp(i8* %8, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0)) #4
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %16

; <label>:11                                      ; preds = %0
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([100 x i8], [100 x i8]* @buffer, i32 0, i32 0))
  %13 = load i8*, i8** %value, align 8
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* %13)
