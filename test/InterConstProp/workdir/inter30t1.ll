...
define i32 @main() #0 {
  ...
  %9 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 0
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8** %9
  %10 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 1
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i8** %10
  %11 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 2
  store i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8** %11
  %12 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 3
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0), i8** %12
  %13 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 4
  store i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0), i8** %13
  %14 = getelementptr [6 x i8*], [6 x i8*]* %8, i32 0, i32 5
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0), i8** %14
...
; <label>:15:                                     ; preds = %30, %0
  ...
  %17 = getelementptr inbounds [6 x i8*], [6 x i8*]* %4, i32 0, i32 0
  %18 = call i32 @getopt_long(i32 %16, i8** %17, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i32 0, i32 0), %struct.option* getelementptr inbounds ([7 x %struct.option], [7 x %struct.option]* @long_options, i32 0, i32 0), i32* %5) #5
...
; <label>:24:                                     ; preds = %20
  ...
  store i32 %26, i32* getelementptr inbounds (%struct.Config, %struct.Config* @config, i32 0, i32 2), align 4
  br label %30

; <label>:27:                                     ; preds = %20
  %28 = load i8*, i8** @optarg, align 8
  %29 = call i32 @atoi(i8* %28) #6
  store i32 %29, i32* getelementptr inbounds (%struct.Config, %struct.Config* @config, i32 0, i32 3), align 4
  br label %30

; <label>:30:                                     ; preds = %20, %27, %24, %23, %22
  br label %15

; <label>:31:                                     ; preds = %15
  %32 = bitcast { i64, i32 }* %6 to i8*
  %33 = bitcast %struct.Config* @config to i8*
  ...
  call void @branchPruned(i64 %35, i32 %37)
