...
${LLVM_OPT_NAME} -load ${TRIMMER_HOME}/build/Remove.so -remove workdir/${1}t3.bc -o workdir/${1}t3.bc 
${LLVM_OPT_NAME} -O3 workdir/${1}t3.bc -o workdir/${2}.bc
${LLVM_DIS_NAME}  workdir/${1}t1.bc
${LLVM_DIS_NAME}  workdir/${1}t2.bc
${LLVM_DIS_NAME}  workdir/${1}t3.bc
${LLVM_DIS_NAME}  workdir/${2}.bc
${LLVM_OPT_NAME} -load ${TRIMMER_HOME}/build/testPass.so -testing workdir/${2}.bc -o workdir/${2}.bc
