...
opt-3.8 -load ~/fileIO/lib/InterConstProp.so -mem2reg -simplifycfg -inter-constprop workdir/${1}t1.bc -o workdir/${1}t2.bc
opt-3.8 -load ~/fileIO/lib/InterConstProp.so -mem2reg -constprop -inter-constprop workdir/${1}t2.bc -o workdir/${1}t3.bc
