...
define void @func(i8* %buffer) #0 {
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* %11)
  %13 = load i8*, i8** %value, align 8
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0), i8* %13)
  %15 = load i8*, i8** %value, align 8
  %16 = call i32 @strcmp(i8* %15, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0)) #4
  %17 = icmp eq i32 %16, 0
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i64 0, i64 90
...
; <label>:7                                       ; preds = %0
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.6, i32 0, i32 0))
  br label %9

; <label>:9                                       ; preds = %7, %0
  %10 = getelementptr inbounds [100 x i8], [100 x i8]* %buffer, i32 0, i32 0
  call void @func(i8* %10)
  ret i32 0
}
