...
python $TRIMMER_HOME/tool/wrapper.py gzip
...
cmd = "python $TRIMMER_HOME/tool/slider.py "+progName+".manifest "+" depth "+"0 5" 
run_in_dir(cmd,"./")

cmd = "python $TRIMMER_HOME/tool/memory.py "+progName+ " depth 0 5"
run_in_dir(cmd,progName+"_"+"DEPTH_0_5")

cmd = "python $TRIMMER_HOME/tool/slider.py "+progName+".manifest "+" percent "+"10 70"     
run_in_dir(cmd,"./")

cmd = "python $TRIMMER_HOME/tool/memory.py "+progName+ " percent 10 70"
