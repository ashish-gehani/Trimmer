...
static void updateBranchWeights2(BasicBlock *Header, BranchInst *LatchBR,
...
static void cloneLoopBlocks2(Loop *L, unsigned IterNumber, BasicBlock *InsertTop,
...
/// optimizations.
bool peelLoop2(Loop *L, unsigned PeelCount, LoopInfo *LI,
  ...
  for (unsigned Iter = 0; Iter < PeelCount; ++Iter) {
    ...
    cloneLoopBlocks2(L, Iter, InsertTop, InsertBot, Exit,
                    NewBlocks, LoopBlocks, VMap, LVMap, LI);
    updateBranchWeights2(InsertBot, cast<BranchInst>(VMap[LatchBR]), Iter,
